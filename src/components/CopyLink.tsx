...
export default function CopyLink({ id }: { id: number }) {
  ...
  return (
    <div className="my-12 flex gap-2 ">
      <Input ref={copyRef} className="max-w-2xs focus-visible:ring-0 focus-visible:border-inherit focus-visible:border-[1px]" defaultValue={`${import.meta.env.VITE_API_URL}share?id=${encodedId}`} readOnly />
